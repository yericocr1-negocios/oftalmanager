        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
              ...
              <div className="text-center text-gray-500 py-8 text-sm">No hay ventas registradas aun</div>
            </div>
            <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
              <h3 className="font-semibold mb-4">Proximas citas</h3>
              <div className="text-center text-gray-500 py-8 text-sm">No hay citas programadas aun</div>
            </div>
          </div>
        </div>
      </div>
